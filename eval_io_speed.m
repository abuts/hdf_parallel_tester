...
N_att = 1; % number of times to read/write similar files to collect proper IO statistics
minN_blocks = 100; % minimal number of blocks to write (filesize = minN_blocks*max(block_size))
