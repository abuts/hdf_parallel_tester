...
public:
	...
	size_t read_pixels(std::vector<size_t> &block_pos, 
		std::vector<size_t> &block_sizes, size_t start_pos, 
...
private:
	...
	hsize_t set_block_params(size_t &block_pos, size_t &block_size, 
